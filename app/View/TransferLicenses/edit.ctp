...
<?php echo $this->Form->create('TransferLicense'); ?>
	<fieldset>
		<legend><?php echo __('Edit Transfer License'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TransferLicense.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('TransferLicense.id')))); ?></li>
