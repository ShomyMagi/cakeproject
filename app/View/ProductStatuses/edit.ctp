...
<?php echo $this->Form->create('ProductStatus'); ?>
	<fieldset>
		<legend><?php echo __('Edit Product Status'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProductStatus.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ProductStatus.id')))); ?></li>
